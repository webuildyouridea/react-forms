  ...
  _createClass(TextArea, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          sheet = _props.sheet,
          otherProps = _objectWithoutProperties(_props, ['name', 'value', 'className', 'onChange', 'validators', 'errorMessage', 'hideErrors', 'classes', 'sheet']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('textarea', _extends({ name: name,
          className: (0, _classnames2.default)(classes.muub__input, (_classNames = {}, _defineProperty(_classNames, classes.muub__textArea, true), _defineProperty(_classNames, className, true), _defineProperty(_classNames, classes.muub__invalidInput, !this.state.isValid), _classNames)),
          value: value,
