...
var TextInput = function (_React$Component) {
  ...
  function TextInput(props) {
    ...
    _this._onBlur = function (e) {
      var _this$context$form2 = _this.context.form,
          inputDidChange = _this$context$form2.inputDidChange,
          validateInput = _this$context$form2.validateInput;


      if (!_this.state.errors.forced) {
        validateInput(_this);
      }
  ...
  _createClass(TextInput, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          sheet = _props.sheet,
          otherProps = _objectWithoutProperties(_props, ['name', 'type', 'value', 'onChange', 'validators', 'errorMessage', 'hideErrors', 'className', 'classes', 'sheet']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', _extends({ name: name,
          type: type || 'text',
          className: (0, _classnames2.default)(classes.muub__input, (_classNames = {}, _defineProperty(_classNames, classes.muub__invalidInput, !this.state.isValid), _defineProperty(_classNames, className, true), _classNames)),
          value: value,
